...
const Index = () => {
  ...
  return (
    <>
      <div className=" min-h-screen mb-20 bg-gray-100 text-gray-900 flex justify-center">
              ...
              <form className="w-full flex-1" onSubmit={(e) => handleSubmit(e)}>
                <div className="mx-auto max-w-xs [&_input]:backdrop-blur-2xl duration-200">
                  <input
                    ...
                    placeholder="Email"
                    className="w-full px-8 py-4 rounded-lg font-medium border border-white/20 placeholder-gray-500 text-sm focus:border-gray-400 bg-transparent focus:bg-white/25 hover:shadow-md duration-200"
                    required
                  />
                  <input
                    type="password"
                    ...
                    className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-white/20 placeholder-gray-500 text-sm focus:border-gray-400 bg-transparent focus:bg-white/25 mt-5 hover:shadow-md duration-200"
                    required
                  />
                  <button
